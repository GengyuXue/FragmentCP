...
smooth_function <- function(data, num_basis = 4, rangeval = c(0,1), no_grids = 30){
...
for (i in 1:100){
  ...
  # data1 = temp_fragment_data11(mu = 0, sigma1, n = 100, m = 20, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.6)
  # data2 = temp_fragment_data12(mu = 0, sigma2, n = 100, m = 20, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.6)
...
var.diff_K <- var(abs(K_matrix - true_K_mat)[1,]/300)

mean.Hausdroff_distance <- mean(Hausdroff_distance)/300
var.Hausdroff.distance <- var(Hausdroff_distance[1,]/300)
...
# write.csv(result, "setting_150_WCUSUM_eval30.csv")
