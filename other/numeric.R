...
data2 = fragment_data2(mu = 0, r = r2, sigma2, n = 100, m = 10, sigma_epsilon = 0.1, domain = c(0, 1), delta = 0.3)
...
cpt_result = DP_fragment(data$t, data$y, data$r, r = 2, lambda, xi = 0.5, ext, maxIt, Delta)
...
for(b in 1:B){
  data1 = fragment_data1(mu = 0, r = r1, sigma1, n = 100, m = 5, sigma_epsilon = 0.1, domain = c(0, 1), delta = 0.3)
