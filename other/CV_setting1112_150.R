...
for (i in 1:iteration) {
  print(c("iteration",i))
  data1 = temp_fragment_data11(mu = 0, sigma1, n = 150, m = 30, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.6)
  data2 = temp_fragment_data12(mu = 0, sigma2, n = 150, m = 30, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.6)
