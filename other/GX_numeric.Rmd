...
Simulate data: 
```{r}
data1 = temp_fragment_data7(mu = 0, r = r1, sigma1, n = 150, m = 30, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.4)
data2 = temp_fragment_data9(mu = 0, r = r2, sigma2, n = 150, m = 30, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.4)
...
Change point:
```{r}
cpt_result = DP_fragment(data$t, data$y, data$r, r = 3, lambda, xi = 1600, ext, maxIt, Delta=0)
...
CV:
```{r}
CV_cpt_result = CV_fragment(data$t, data$y, data$r, r = 3, lambda, xi = 800, ext, maxIt)
# cpt_result = DP_fragment(data$t, data$y, data$r, r = 3, lambda, xi = 35000, ext, maxIt, Delta=1)
cpt_result$partition
cpt_result$bestvalue
part2local(cpt_result$partition)
