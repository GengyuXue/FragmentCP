...
```{r}
cov.obj_whole <- cov_basis(data$t[1:120,], data$y[1:120,], data$r[,1:3600], r1, lambda, ext, maxIt)
cov.obj_first <- cov_basis(data$t[1:115,], data$y[1:115,], data$r[,1:3450], r1, lambda, ext, maxIt)
cov.obj_second <- cov_basis(data$t[116:120,], data$y[116:120,], data$r[, 3451:3600], r1, lambda, ext, maxIt)
...
Change point:
```{r}
cpt_result = DP_fragment(data$t, data$y, data$r, r = 3, lambda, xi = 100000, ext, maxIt, Delta=15)
