...
for (i in 1:iteration) {
  ...
  # m = 10
  # zeta_set = c(2200, 2300, 2500, 2700, 2900, 3000)
  
  # m =20
  # zeta_set = c(3500, 4000, 4300, 4500, 4900)
  
  # m =30
  # zeta_set = c(4300, 4500, 4900, 5500, 5900)
  
  # m = 40
  zeta_set = c(4300, 4500, 4900, 5500, 5900)
  CV_SBS_result = CV_search_SBS_fragment(data$t, data$y, data$r, r=3, lambda, ext, maxIt, zeta_set, Delta = 10)
