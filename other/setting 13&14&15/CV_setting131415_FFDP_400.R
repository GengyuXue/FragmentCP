...
for (i in 1:iteration) {
  set.seed(1000+10*i)
  print(c("iteration",i))
  data1 = temp_fragment_data13(mu = 0, r = 2, 1, n = 100, m = 15, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.5)
  data2 = temp_fragment_data14(mu = 0, r = 2, 1, n = 150, m = 15, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.5)
  data3 = temp_fragment_data15(mu = 0, r = 2, 1, n = 150, m = 15, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.5)
  
  data = list("t"= rbind(data1$t, data2$t, data3$t), "y" = rbind(data1$y, data2$y, data3$y), "r" = cbind(data1$r, data2$r, data3$r))
  
  # xi_set = c(900, 950, 1000, 1050)
  # xi_set = c(1000, 1050, 1100, 1150)
  # xi_set = c(1100, 1150, 1200, 1250)
  # xi_set = c(1200, 1300, 1400, 1500)
  
  xi_set = c(1150, 1200, 1600, 1700)
  ...
  xi_set[min_idx]
  cpt_init = c(0, unlist(CV_cpt_result$cpt_hat[min_idx]), 400)
...
sd.Hausdroff.distance <- sqrt(var(Hausdroff_distance[1,]/400))
