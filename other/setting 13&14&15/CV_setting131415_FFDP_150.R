...
for (i in 1:iteration) {
  ...
  xi_set[min_idx]
  cpt_init = c(0, unlist(CV_cpt_result$cpt_hat[min_idx]), 150)
...
sd.Hausdroff.distance <- sqrt(var(Hausdroff_distance[1,]/150))
...
print(result)
# write.csv(result, "CV_setting131415_FFDP_150.csv")
