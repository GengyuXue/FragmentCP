...
for (i in 1:iteration) {
  set.seed(1000+10*i)
  print(c("iteration",i))
  data1 = temp_fragment_data13(mu = 0, r = 2, 1, n = 50, m = 20, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.5)
  data2 = temp_fragment_data14(mu = 0, r = 2, 1, n = 75, m = 20, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.5)
  data3 = temp_fragment_data15(mu = 0, r = 2, 1, n = 75, m = 20, sigma_epsilon = 0.01, domain = c(0, 1), delta = 0.5)
  
  data = list("t"= rbind(data1$t, data2$t, data3$t), "y" = rbind(data1$y, data2$y, data3$y), "r" = cbind(data1$r, data2$r, data3$r))
  
  xi_set = c(450, 480, 500, 550)
